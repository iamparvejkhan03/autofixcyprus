            ...
            <div className="flex flex-col items-center justify-center text-center py-12 px-2 md:py-16 ">  
                <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                    ...
                    <span className="text-blue-600">
                        {language === 'en' ? 'Trusted by Customers' : 'Αξιόπιστοι από τους Πελάτες'}
                    </span>
                </div>
                <h2 className="text-2xl md:text-4xl font-medium mt-2">
                    {language === 'en' ? 'Fast, Reliable Car Repair' : 'Γρήγορη και Αξιόπιστη Επισκευή Αυτοκινήτου'}
                    <br />
                    {language === 'en' ? '— When You Need It Most' : '— Όταν το χρειάζεστε περισσότερο'}
                </h2>
                <p className="text-gray-400 mt-2 max-w-5xl max-md:text-sm">
                    {language === 'en' ? 'Achieve your goals faster with personalized strategies, hands-on support, and results that speak for themselves.' : 'Πετύχετε τους στόχους σας πιο γρήγορα με εξατομικευμένες στρατηγικές, πρακτική υποστήριξη και αποτελέσματα που μιλούν από μόνα τους.'}
                </p>
                ...
                <div className="flex gap-3 flex-wrap items-center justify-center">
                    ...
                    <button onClick={() => navigate('/contact')} type="button" className="bg-blue-600 text-white text-sm px-5 py-2.5 rounded-md cursor-pointer font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300 inline-flex gap-1"> 
