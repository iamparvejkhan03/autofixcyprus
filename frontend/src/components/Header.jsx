            ...
            <Container className={`flex justify-between py-5 ${isScrolled && 'shadow-lg bg-white'}`}>
                ...
                <nav className="hidden lg:block">
                    <ul className="flex items-center gap-7">
                        ...
                        <LanguageSwitcher />
                        <li>
                            <Link to='tel:+35799568745' className="inline-flex items-center justify-center text-white whitespace-nowrap rounded-md text-sm font-medium h-10 px-4 py-2 bg-blue-600 hover:bg-blue-700">
