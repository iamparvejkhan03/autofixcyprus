    ...
    return (
        <Container classNameName="mt-14">
            <div className="p-8 text-center border border-blue-200 rounded-lg bg-blue-50 mt-14">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Trusted Insurance Partner</h3>
                <p className="text-lg text-gray-700 mb-6">
                    We work directly with all major insurance companies in Cyprus, ensuring seamless claim processing and maximum coverage for your repairs.
                </p>
